...
gui_init(int argc, char** argv)
{
	...
	if (nsoption_charp(cookie_file) == NULL) {
		nsoption_set_charp(cookie_file, strdup("PROGDIR:Resources/Cookies"));
		LOG(("Using '%s' as Cookies file", nsoption_charp(cookie_file)));
	}

	if (nsoption_charp(cookie_jar) == NULL) {
		nsoption_set_charp(cookie_jar, strdup("PROGDIR:Resources/Cookies"));
...
main(int argc, char** argv)
{
	...
	respaths = fb_init_resource("PROGDIR:fonts");
